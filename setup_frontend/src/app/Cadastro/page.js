            ...
            <section className="flex justify-center items-center box-border ">
                <div className="mt-30 md:m-10 w-fit p-10 md:p-25 rounded text-black shadow-2xl md:text-3xl">
                    ...
                    <div className="md:my-10">
                        <h2 className="font-light underline underline-offset-2 decoration-sky-200">Usuário</h2> 
                        ...
                        md:border-2 m-3" placeholder="Digite seu nome de Usuário"/>
                    </div>
                    ...
                    <div className="md:my-10">
                        <h2 className="font-light underline underline-offset-2 decoration-sky-200">Confirme sua senha :</h2> 
                        <input className="placeholder:text-gray-500 placeholder:italic placeholder:text-xl 
                        placeholder:text-center border-1 border-indigo-300
                        md:border-2 m-3" placeholder="Digite sua senha novamente" type="password"/>
                    </div>
