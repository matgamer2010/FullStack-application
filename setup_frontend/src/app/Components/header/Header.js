        ...
        <section>
            ...
            md:mt-5 md:mx-5 sm:mt-3 sm:mx-3 ">
                ...
                <Link href="/" legacyBehavior>
                    ...
                    ml-7 mr-0  lg:mx-5 md:mx-5 md:scale-100 md:ml-1 md:text-stone-800">{props.h1}</h1>
                </Link>
                ...
                <Link href="User/">
                    ...
                    border-none transition duration-200 ease-out hover:scale-110 hover:translate-y-1 scale-70 md:scale-100 mr-10
